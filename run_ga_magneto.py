...
class MAGNETO:
    def __init__(self, hw_config='', model_name='', popluation_size=100, max_generations=10, power_constraint=1000, layer_index=0):
    ...
    def run_ga(self, dimensions):
        self.dimensions = dimensions[self.layer_index]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--power_budget_mw', type=int, default=1000, help='Power budget in mW, Eyeriss 450mW')
    parser.add_argument('--layer', type=int, default=0, help='For multi-layer optimization, specify the layer index')
